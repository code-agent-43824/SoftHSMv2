...
log "P11_TEST_REQUIRE_GOST_IMPORT_EXPORT=${P11_TEST_REQUIRE_GOST_IMPORT_EXPORT:-YES}"
log "P11_TEST_REQUIRE_GOST_SYMMETRIC=${P11_TEST_REQUIRE_GOST_SYMMETRIC:-YES}"
log "P11_TEST_REQUIRE_RSA_IMPORT_EXPORT=${P11_TEST_REQUIRE_RSA_IMPORT_EXPORT:-YES}"
log "P11_TEST_EXCLUDE_FUNCTIONS=${P11_TEST_EXCLUDE_FUNCTIONS:-<none>}"
